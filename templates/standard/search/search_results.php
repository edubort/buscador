...
?>
<br>
<section name="secao_da_esquerda" class="col-md-8">

	<section id="anuncio-topo" id="anuncio-topo" class="marg-bt-2 padd-05 bgAmareloClaro">
		<div name="anuncio">
			<header>
				<a href="#" class="font-1-2"><strong>Viajar</strong>.com</a>
				<br>

				<legend class="flex conteudo-between" style="text-overflow: ellipsis; overflow: hidden;">
					<span class="color-green">
						www.viajar.com/.../buscador/
					</span>
					<span>
						9 dias al <strong>Caribe</strong>
					</span>
				</legend>
			</header>
		</div>
...
<section name="secao_da_direita" class="col-md-4">
	...
	<section id="anuncio-topo" id="anuncio-topo" class="marg-bt-2 padd-05 bgAmareloClaro">
		<div name="anuncio">
			<header>
				<a href="#" class="font-1-2"><strong>Viajar</strong>.com</a>
				<br>
				<legend class="flex flex-coluna">
					<span>
						Avion + Traslado + Hotel
					</span>
					<span class="color-green">
						www.viajar.com/.../buscador/
					</span>
